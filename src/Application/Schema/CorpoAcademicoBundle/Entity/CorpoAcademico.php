...
namespace App\Application\Schema\CorpoAcademicoBundle\Entity;

use App\Application\Schema\CorpoAcademicoBundle\Repository\CorpoAcademicoRepository;
use App\Application\Schema\TituloBundle\Entity\Titulo;
